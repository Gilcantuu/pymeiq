// Navbar with the Week 2 addition: Research link.
    ...
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/80 backdrop-blur">
      ...
      >
        ...
        <div className="flex items-center gap-5 text-sm font-medium text-slate-700">
          ...
          <Link href="/core" className="hover:text-brand-600">Core</Link>
          <Link href="/research" className="hover:text-brand-600">Research</Link>
